...
##Applying RIGHT JOIN using LEFT JOIN b/w both tables
cur.execute("SELECT ID, NAME, AMOUNT, DATE FROM Orderr LEFT JOIN Customer ON  Customer.ID = Orderr.CUSTOMER_ID;")
rows = cur.fetchall()
for row in rows:
